...
table.insert(PLAYER_SPAWNS, {
    ...
    rotation = Rotator(0.000000, -60.000061, 0.000000)
})
table.insert(PLAYER_SPAWNS, {
...
table.insert(PLAYER_SPAWNS, {
    ...
    rotation = Rotator(0.000000, -15.000061, 0.000000)
})
table.insert(PLAYER_SPAWNS, {
    location = Vector(-14998.000, -13610.000, -2118.000),
    rotation = Rotator(0.000000, -5.000000, 0.000000)
})
table.insert(PLAYER_SPAWNS, {
    location = Vector(-14564.000, -13107.000, -2084.000),
    rotation = Rotator(0.000000, -25.000061, 0.000000)
})
table.insert(PLAYER_SPAWNS, {
...
table.insert(MAP_DOORS, {
    ...
    rotation = Rotator(0.000000, 130.000046, 0.000000),
...
table.insert(MAP_DOORS, {
    ...
    rotation = Rotator(38.881363, 166.888107, -24.204620),
...
table.insert(MAP_DOORS, {
    ...
    rotation = Rotator(0.000000, -10.000031, 0.000000),
...
table.insert(MAP_WEAPONS, {
    ...
    rotation = Rotator(0.000000, 30.000050, 0.000000),
    price = 800,
    weapon_name = "SMG11",
    max_ammo = 300
})
table.insert(MAP_WEAPONS, {
    ...
    rotation = Rotator(0.000000, 85.000000, 0.000000),
    price = 800,
...
table.insert(MAP_WEAPONS, {
    ...
    rotation = Rotator(0.000000, 50.000046, 0.000000),
    price = 1000,
    weapon_name = "AP5",
    max_ammo = 300
})
...
table.insert(MAP_WEAPONS, {
    ...
    rotation = Rotator(0.000000, -65.000092, 0.000000),
    price = 1200,
    weapon_name = "AR4",
    max_ammo = 400
})
table.insert(MAP_WEAPONS, {
    ...
    rotation = Rotator(0.000000, -165.000046, 0.000000),
    price = 1200,
    weapon_name = "Rem870",
    max_ammo = 100
})
table.insert(MAP_WEAPONS, {
    ...
    rotation = Rotator(0.000000, -40.000061, 0.000000),
    price = 500,
...
table.insert(MAP_ROOMS[5], {
    ...
    barricade_rotation = Rotator(0.000000, 50.000088, 0.000000),
    z_move_to_b_target_location = Vector(7264.605, -1740.279, 190.902),
    z_reach_rotation = Rotator(0.000000, 140.000088, -0.000000),
    z_leave_b_tp_location = Vector(7111.395, -1611.721, 190.902),
    z_spawns = {},
    type = "barricade",
    z_leave_b_tp_rotation = Rotator(0.000000, 140.000088, -0.000000),
    z_ground_debris_location = Vector(7080.754, -1586.010, 190.902)
})
table.insert(MAP_ROOMS[8], {
    barricade_location = Vector(15810.000, -2875.000, 179.000),
    barricade_rotation = Rotator(0.000000, -170.000046, 0.000000),
    z_move_to_b_target_location = Vector(15798.971, -2812.454, 30.804),
    z_reach_rotation = Rotator(-0.000000, -80.000046, 0.000000),
    z_leave_b_tp_location = Vector(15821.029, -2937.546, 30.804),
    z_spawns = {},
    type = "barricade",
    z_leave_b_tp_rotation = Rotator(-0.000000, -80.000046, 0.000000),
    z_ground_debris_location = Vector(15827.974, -2976.939, 30.804)
})
table.insert(MAP_ROOMS[1], {
    ...
    z_reach_rotation = Rotator(0.000000, 19.999878, -0.000000),
    z_leave_b_tp_location = Vector(-16337.117, -14243.164, -1808.000),
    z_spawns = {},
    type = "barricade",
    z_leave_b_tp_rotation = Rotator(0.000000, 19.999878, -0.000000),
    z_ground_debris_location = Vector(-16299.529, -14229.484, -1808.000)
})


MAP_PACK_A_PUNCH = {
    location = Vector(71682.000, 2387.000, -7618.000),
    rotation = Rotator(0.000000, 10.000046, 0.000000),
    weapon_location = Vector(71643.486, 2444.181, -7535.000),
    weapon_rotation = Rotator(0.000000, 10.000046, -0.000000)
}


MAP_POWER = {
    location = Vector(12844.000, -4986.000, 353.000),
    rotation = Rotator(0.000000, 80.000069, 0.000000),
    handle_location = Vector(12825.289, -4982.701, 470.000),
    handle_rotation = Rotator(0.000000, 80.000069, 90.000000)
}
...
table.insert(MAP_MYSTERY_BOXES, {
    ...
    rotation = Rotator(0.000000, 162.000000, 0.000000)
})
table.insert(MAP_MYSTERY_BOXES, {
    location = Vector(69909.000, 2204.000, -7815.000),
    rotation = Rotator(-5.000000, 179.999985, 0.000002)
})
table.insert(MAP_MYSTERY_BOXES, {
    location = Vector(145.000, -4153.000, 709.000),
    rotation = Rotator(0.000000, -149.999924, 0.000000)
})
table.insert(MAP_MYSTERY_BOXES, {
    location = Vector(4891.000, -1744.000, 295.000),
    rotation = Rotator(0.000000, 90.000122, 0.000000)
})
...
MAP_PERKS.stamin_up = {
    ...
    rotation = Rotator(0.000000, -135.000061, 0.000000)
}
MAP_PERKS.speed_cola = {
    location = Vector(13482.000, -4615.000, 360.000),
    rotation = Rotator(0.000000, 35.000000, 0.000000)
}
...
table.insert(MAP_TELEPORTERS, {
    ...
    teleport_to = {
        ...
        },
        {
            ...
            rotation = Rotator(0.000000, -20.000061, 0.000000)
        },
        {
    ...
    teleport_back = {
        ...
        },
        {
            ...
            rotation = Rotator(0.000000, -50.000061, 0.000000)
        },
        {
...
table.insert(MAP_ROOMS[2], {
    type = "vault",
    z_spawns = {},
    z_target_location_1 = Vector(-7407.413, -17365.530, -2100.000),
    z_target_rotation_1 = Rotator(0.000000, 49.999939, -0.000000),
    z_leave_location_1 = Vector(-7098.875, -16997.829, -2100.000),
    z_leave_rotation_1 = Rotator(0.000000, 49.999939, -0.000000),
    z_target_location_2 = Vector(-7384.916, -17338.718, -2100.000),
    z_target_rotation_2 = Rotator(0.000000, 49.999939, -0.000000),
    z_leave_location_2 = Vector(-7176.010, -17089.754, -2100.000),
    z_leave_rotation_2 = Rotator(0.000000, 49.999939, -0.000000)
})
table.insert(MAP_ROOMS[5], {
    type = "vault",
    z_spawns = {},
    z_target_location_1 = Vector(7352.526, 545.999, -149.000),
    z_target_rotation_1 = Rotator(0.000000, -150.000229, 0.000000),
    z_leave_location_1 = Vector(6936.833, 306.001, -149.000),
    z_leave_rotation_1 = Rotator(0.000000, -150.000229, 0.000000),
    z_target_location_2 = Vector(7322.215, 528.499, -149.000),
    z_target_rotation_2 = Rotator(0.000000, -150.000229, 0.000000),
    z_leave_location_2 = Vector(7040.756, 366.000, -149.000),
    z_leave_rotation_2 = Rotator(0.000000, -150.000229, 0.000000)
})
table.insert(MAP_ROOMS[2], {
    type = "vault",
    z_spawns = {},
    z_target_location_1 = Vector(-9212.000, -16556.525, -2117.000),
    z_target_rotation_1 = Rotator(0.000000, 120.000065, -0.000000),
    z_leave_location_1 = Vector(-9452.000, -16140.834, -2117.000),
    z_leave_rotation_1 = Rotator(0.000000, 120.000065, -0.000000),
    z_target_location_2 = Vector(-9229.500, -16526.215, -2117.000),
    z_target_rotation_2 = Rotator(0.000000, 120.000065, -0.000000),
    z_leave_location_2 = Vector(-9392.000, -16244.757, -2117.000),
    z_leave_rotation_2 = Rotator(0.000000, 120.000065, -0.000000)
})
...
table.insert(MAP_LIGHT_ZONES, {
    ...
    rotation = Rotator(0.000000, 25.000031, 0.000000),
...
table.insert(MAP_ROOMS[3], {
    ...
    rotation = Rotator(0.000000, -20.000031, 0.000000),
    ground_anim = true
})
table.insert(MAP_ROOMS[3], {
    type = "ground",
    location = Vector(-6981.000, -11719.000, -2118.000),
    rotation = Rotator(0.000000, 70.000114, 0.000000),
    ground_anim = true
})
table.insert(MAP_ROOMS[3], {
    type = "ground",
    location = Vector(-4871.000, -10785.000, -2148.000),
    rotation = Rotator(0.000000, -100.000153, 0.000000),
    ground_anim = true
})
...
table.insert(MAP_ROOMS[4], {
    ...
    rotation = Rotator(0.000000, -130.000153, 0.000000),
    ground_anim = true
})
table.insert(MAP_ROOMS[4], {
    type = "ground",
    location = Vector(-6692.000, -7871.000, -1206.000),
    rotation = Rotator(0.000000, 30.000061, 0.000000),
    ground_anim = true
})
table.insert(MAP_ROOMS[4], {
    type = "ground",
...
table.insert(MAP_ROOMS[5], {
    ...
    rotation = Rotator(0.000000, 50.000084, 0.000000),
    ground_anim = true
})
table.insert(MAP_ROOMS[5][1].z_spawns, {
    location = Vector(7452.000, -1784.000, 183.000),
    rotation = Rotator(0.000000, 170.000198, 0.000000),
    ground_anim = true
})
...
table.insert(MAP_ROOMS[6], {
    ...
    rotation = Rotator(0.000000, 30.000065, 0.000000),
    ground_anim = true
})
table.insert(MAP_ROOMS[6], {
    type = "ground",
...
table.insert(MAP_ROOMS[7], {
    ...
    rotation = Rotator(0.000000, -80.000061, 0.000000),
    ground_anim = true
})
table.insert(MAP_ROOMS[8][1].z_spawns, {
    location = Vector(15792.000, -2396.000, -183.000),
    rotation = Rotator(0.000000, -90.000061, 0.000000),
    ground_anim = true
})
table.insert(MAP_ROOMS[8], {
    type = "ground",
...
table.insert(MAP_ROOMS[8], {
    ...
    rotation = Rotator(0.000000, 105.000046, 0.000000),
    ground_anim = true
})
table.insert(MAP_ROOMS[8], {
    type = "ground",
...
table.insert(MAP_ROOMS[1], {
    ...
    rotation = Rotator(0.000000, -110.000153, 0.000000),
    ground_anim = true
})
table.insert(MAP_ROOMS[1], {
    type = "ground",
...
table.insert(MAP_ROOMS[2][2].z_spawns, {
    ...
    rotation = Rotator(0.000000, -170.000244, 0.000000),
    ground_anim = true
})
...
table.insert(MAP_ROOMS[3], {
    ...
    rotation = Rotator(0.000000, 160.000168, 0.000000),
    ground_anim = true
})
table.insert(MAP_ROOMS[1][1].z_spawns, {
    location = Vector(-17201.000, -15362.000, -1722.000),
    rotation = Rotator(0.000000, 40.000053, 0.000000),
    ground_anim = true
})
